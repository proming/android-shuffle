...
import static org.dodgybits.shuffle.android.server.gcm.CommonUtilities.SENDER_ID;
...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    private static void generateNotification(Context context, String message) {
        ...
        Intent notificationIntent = new Intent(context, PreferencesAppEngineSynchronizationActivity.class);
