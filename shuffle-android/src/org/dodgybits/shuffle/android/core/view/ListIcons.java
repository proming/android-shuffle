...
public class ListIcons {
    ...
    public static final int INBOX = R.drawable.format_justify_fill;
    public static final int DUE_TODAY = R.drawable.office_calendar;
    public static final int DUE_NEXT_WEEK = R.drawable.office_calendar;
    public static final int DUE_NEXT_MONTH = R.drawable.office_calendar;
