...
import org.dodgybits.shuffle.android.list.old.config.ProjectExpandableListConfig;
import org.dodgybits.shuffle.android.list.old.view.ExpandableProjectView;
import org.dodgybits.shuffle.android.list.old.view.ExpandableTaskView;
import org.dodgybits.shuffle.android.list.old.view.ProjectView;
...
public class ExpandableProjectsActivity extends AbstractExpandableActivity<Project,ProjectSelector> {
    ...
    @Inject
    ProjectExpandableListConfig mListConfig;
    @Inject
		...
		return new MyExpandableListAdapter(this, 
	        ...
	        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
				...
				if (convertView instanceof ExpandableTaskView) {
                    ...
                    taskView = mTaskViewProvider.get(ExpandableProjectsActivity.this);
				}
