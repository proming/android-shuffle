...
public class ContextListConfig implements DrilldownListConfig<Context, ContextSelector> {
    ...
    @Inject
    public ContextListConfig(ContextPersister contextPersister, TaskPersister taskPersister, @ContextTasks ListSettings settings) {
    ...
    @Override
    public ListSettings getListPreferenceSettings() {
        return mSettings;
    }
}
